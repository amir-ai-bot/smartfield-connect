                          ...
                          <TableRow key={fournisseur.id}>
                            <TableCell>
                              <div className="flex items-center gap-3">
                                <Avatar className="h-9 w-9">
                                  {fournisseur.avatar ? (
                                    <AvatarImage src={fournisseur.avatar} alt={fournisseur.display_name} />
                                  ) : null}
                                  <AvatarFallback className="bg-gray-100 text-gray-700">
                                    {fournisseur.display_name ? fournisseur.display_name.charAt(0).toUpperCase() : 'U'}
                                  </AvatarFallback>
                                </Avatar>
                                <div className="font-medium">{fournisseur.display_name || 'Unnamed User'}</div>
                              </div>
                            </TableCell>
